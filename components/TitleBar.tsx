...
SiteLightnessContext, BrightnessContext, ContrastContext, HueContext, SaturationContext, 
LightnessContext, BlurContext, SharpenContext, PixelateContext, ImageSizeContext,
ActiveDropdownContext} from "../Context"
...
const colorList = {
    ...
    "--sliderBG": "#1f030d",
    "--inputBG": "#55092a",
    "--patternBorder": "#dd1568",
    "--patternBorder2": "#dd34a5",
    "--navbarButtonBG": "#220512",
    "--navbarButtonBorder": "#ee1fc1",
    "--selectBorder": "#ed1cab"
}
